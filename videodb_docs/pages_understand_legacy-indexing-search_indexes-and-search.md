...
[Search Patterns and Results](\pages\understand\search-and-retrieval\collection-search) [Create an Index](\pages\understand\legacy-indexing-search\create-an-index)
