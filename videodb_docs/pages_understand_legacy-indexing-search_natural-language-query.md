...
[Multiple Indexes](\pages\understand\legacy-indexing-search\multiple-indexes) [Timestamps, Clips, Streams](\pages\understand\legacy-indexing-search\timestamps-clips-streams)
