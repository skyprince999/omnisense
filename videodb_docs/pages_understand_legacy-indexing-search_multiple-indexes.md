...
[Frame Processing Primitives](\pages\understand\legacy-indexing-search\multimodal-indexing) [Natural Language Query](\pages\understand\legacy-indexing-search\natural-language-query)
